...
/**
 * Display of a ticket in dialog form
 * @param {*} props Information related to the ticket that will be used for the display
 * @returns {void} Display of a ticket in dialog form
 */
