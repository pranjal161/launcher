...
const OverDue = (props: { value: any }) => (
    <svg id="Reminder" xmlns="http://www.w3.org/2000/svg" width="143" height="32" viewBox="0 0 143 32">
        <rect id="Rectangle_49" width="120" height="32" rx="4" fill="#fee" />
...
const DueTo = (props: { value: any }) => (
    <svg id="Reminder" xmlns="http://www.w3.org/2000/svg" width="130" height="32" viewBox="0 0 130 32">
        <rect id="Rectangle_49" data-name="Rectangle 49" width="120" height="32" rx="4" fill="#fffbea" />
...
const DayLeft = (props: { value: any }) => (
    <svg id="Reminder" xmlns="http://www.w3.org/2000/svg" width="115" height="35" viewBox="0 0 115 35">
        <rect id="Rectangle_49" data-name="Rectangle 49" width="120" height="35" rx="4" fill="#f5f7fa" />
...
export const NotificationIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="143" height="32" viewBox="0 0 143 32">
        ...
        <text id="Overdue_3_days" transform="translate(32 21)" fill="#cf1124" fontSize="14" ><tspan x="0" y="0">Today</tspan></text>
    </svg>
)
