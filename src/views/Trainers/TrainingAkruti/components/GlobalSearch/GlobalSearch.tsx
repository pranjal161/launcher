...
const GlobalSearch = (props: { getAvailableOptions: (value: string) => { href: string, options: Array<{ label: string, value: string }> }, getSearchOptions: (url: string) => Promise<any>, selectedEntity?: string }) => {
    ...
    const selectedEntity = props.selectedEntity ? props.selectedEntity : '';
    const [selected, setSelected] = React.useState({ entity: selectedEntity, property: '', propertyTitle: '', searched: '' });
    ...
    React.useEffect(() => {
        if (props.selectedEntity) {
            entityChange(props.selectedEntity);
        }
