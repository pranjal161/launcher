...
import ActivitiesTable from 'views/CcontractSummary/components/ActivitiesTable/ActivitiesTable';
import { ApplicationContext } from 'context/applicationContext';
import ClausesTable from 'views/CcontractSummary/components/ClausesTable/ClausesTable';
import CoverageTable from 'views/CcontractSummary/components/CoveragesTable/CoveragesTable';
import Documents from 'components/Ddocuments/Documents';
import FinancialInformation from 'views/CcontractSummary/components/FinancialInformation/FinancialInformation';
import FinancialOperationTable from 'views/CcontractSummary/components/FinancialOperationTable/FinancialOperationTable';
import InvestmentTab from 'views/CcontractSummary/components/InvestmentTab/InvestmentTab';
import Label from 'components/Llabel/Label';
import PartyRoleTable from 'views/CcontractSummary/components/PartyRoleTable/PartyRoleTable';
import { PersonIcon } from 'assets/svg';
import RiskTable from 'views/CcontractSummary/components/RiskTable/RiskTable';
import { StyledBanner } from 'styles/global-style';
import UnsolicitedPayment from 'views/CcontractSummary/components/UnsolicitedPayment/UnsolicitedPayment';
